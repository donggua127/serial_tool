...
class SerialFrame(object):
    ...
    def create_frm_top(self):
        ...
        self.frm_rr = pytk.PyLabelFrame(self.frm_top)
        ...
        self.frm_rr = pytk.PyLabelFrame(self.frm_top)
        self.frm_rr.pack(fill="both", expand=1, padx=2, pady=5, side=tk.RIGHT)
    ...
    def create_frm_rr(self):
        ...
        self.frm_rr_road_list = pytk.PyListbox(self.frm_rr_road,
                                               font=g_font)
        self.frm_rr_roadfile_list.pack(fill="both", expand=1, padx=5, pady=5, side=tk.LEFT)
        self.frm_rr_road_addBtn.pack(fill="none", expand=1, padx=5, pady=5, side=tk.LEFT)
        self.frm_rr_road_delBtn.pack(fill="none", expand=1, padx=5, pady=5, side=tk.LEFT)
        self.frm_rr_road_list.pack(fill="both", expand=1, padx=5, pady=5, side=tk.LEFT)
