...
class MainFrame(object):
    ...
    def init_serial_frm(self):
        ...
        self.serial_frm.frm_rr_road_addBtn["command"] = self.AddRoad
        self.serial_frm.frm_rr_road_delBtn["command"] = self.DelRoad
        self.serial_frm.frm_rr_roadfile_list.bind("<Double-Button-1>", self.AddRoad)
